...
<div class="container-fluid">
    <div class="row justify-content-center mt-5">
        ...
        <div class="col-5">
            <h1 class="display-4 fs-2 text-left mt-4"><b>Shipping order has been placed successfully!</b></h1>
        </div>
        </div>
    </div>
    <div class="row justify-content-center mt-2">
        <div class="col-12 text-center">
            <a href="shiping_orders.php">
                <button type="button" class="btn btn-lg btn-success">Orders for shipping</button>
            </a>
        </div>
    </div>
