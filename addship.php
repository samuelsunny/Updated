...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
    ...
    $shipping_comapny_id = $real_data['shipping_comapny_id'];
    ...
    $query = "insert into ships (shipName,companyId) values ('{$ship_name}','{$shipping_comapny_id}')";
                ...
                <div class="card p-2">
                    <div class="card-body"> 
                        <form action="addship.php" method = "post" enctype="multipart/form-data">  
                            <div class="mb-4">
                                <label for="exampleFormControlInput1" class="form-label"> Enter ship name </label>
                                <input type="text" class="form-control" name = "ship_name" id="ship_name">
                            </div>


                            <div class="mb-4">
                                <label for="exampleFormControlInput1" class="form-label">Owner shipping company </label>
                                <div class="dropdown">
                                    <select class="form-select" aria-label="Default select example" onchange="setHarbor()" id="harbor">
                                        ...
                                        <?php for ($row = 0; $row < count($shipping_companies_data); $row++) { ?>
                                            
                                            <option value="<?php echo $shipping_companies_data[$row][0]; ?>" >
                                                <?php echo $shipping_companies_data[$row][1]; ?>
                                            </option>
                                        <?php }?>
                                    </select>
                                </div>
