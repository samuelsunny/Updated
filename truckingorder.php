...
$get_drivers = "select * from trucks";
                ...
                <div class="card p-2">
                    <div class="card-body"> 
                        <form action="shippingorderform.php" method = "post">
                            ...
                            <div class="mb-2">
                                <label for="exampleFormControlInput1" class="form-label">Select your departure harbor</label>
                            ...
                            <button  type="submit" onclick = "setJson()"class=" mb-0 btn btn-primary">Raise trucking order</button>
                        </form>
                    </div>
