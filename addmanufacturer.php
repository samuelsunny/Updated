...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
    ...
    $manufacturerAddress  = $_POST['manufacturerAddress'];
    $telephone = $_POST['telephone'];

    if((!empty($manufacturerName)) && (!empty($manufacturerAddress))&&
            (!empty($telephone)))
        {

            // Saving to data base
            $query = "insert into manufacturer (manufacturerName,manufacturerAddress,telephone) values ('$manufacturerName','$manufacturerAddress','$telephone')";
        ...
        <div class="row justify-content-center mt-5">
            <div class="col-6">
                <img src="manufacturing.png" class="img-fluid" alt="Responsive image">
                    ...
                    <ul>
                        <li><p class="mt-4"> Fill the details to add a manufacturer to the database</p> </li>
                    </ul>
            </div>
            <div class="col-6">
                <div class="card p-2">
                    <div class="card-body"> 
                       <form method = "post">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="exampleFormControlInput1" name = "manufacturerName">
                            </div>
            
                            <div class="mb-4">
                                <label for="exampleFormControlInput1" class="form-label">Manufacturer Address</label>
                                <textarea class="form-control" id = "Address" name = "manufacturerAddress" rows="3"></textarea>
                            </div>
